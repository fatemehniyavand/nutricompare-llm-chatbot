...
from nutricompare.application.services.confidence_scorer import ConfidenceScorer
from nutricompare.application.services.food_parser import FoodParser
from nutricompare.application.services.meal_memory_service import MealMemoryService
